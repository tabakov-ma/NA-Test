...
namespace Excel {
    ...
    public partial class Database1DataSet4 : global::System.Data.DataSet {
        ...
        public partial class Table2DataTable : global::System.Data.TypedTableBase<Table2Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table2Row AddTable2Row(int Id, string Name, string Familiya) {
        ...
        public partial class Table2Row : global::System.Data.DataRow {
            ...
            public string Name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Name\' в таблице \'Table2\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string Familiya {
                get {
                    try {
                        return ((string)(this[this.tableTable2.FamiliyaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Familiya\' в таблице \'Table2\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable2.FamiliyaColumn] = value;
                }
            }
            ...
            public bool IsFamiliyaNull() {
                return this.IsNull(this.tableTable2.FamiliyaColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetFamiliyaNull() {
                this[this.tableTable2.FamiliyaColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Excel.Database1DataSet4TableAdapters {
    ...
    public partial class Table2TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table2] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AN" +
                "D [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Familiya = 1 AND [" +
                "Familiya] IS NULL) OR ([Familiya] = @Original_Familiya)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table2] ([Id], [Name], [Familiya]) VALUES (@Id, @Name, @Famili" +
                "ya);\r\nSELECT Id, Name, Familiya FROM Table2 WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table2] SET [Id] = @Id, [Name] = @Name, [Familiya] = @Familiya WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Familiya = 1 AND [Familiya] IS NULL) OR ([Familiya] = @Original_Familiya)));
SELECT Id, Name, Familiya FROM Table2 WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Excel.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Familiya FROM dbo.Table2";
        ...
        public virtual int Fill(Database1DataSet4.Table2DataTable dataTable) {
        ...
        public virtual Database1DataSet4.Table2DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet4.Table2DataTable dataTable = new Database1DataSet4.Table2DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet4.Table2DataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Familiya) {
        ...
        public virtual int Insert(int Id, string Name, string Familiya) {
        ...
        public virtual int Update(int Id, string Name, string Familiya, int Original_Id, string Original_Name, string Original_Familiya) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Familiya, int Original_Id, string Original_Name, string Original_Familiya) {
            return this.Update(Original_Id, Name, Familiya, Original_Id, Original_Name, Original_Familiya);
        }
    }
