...
namespace Excel {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Name, string Familiya) {
...
namespace Excel.Database1DataSet2TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND" +
                " [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Familiya = 1 AND [F" +
                "amiliya] IS NULL) OR ([Familiya] = @Original_Familiya)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Familiya]) VALUES (@Name, @Familiya);\r\nSELECT" +
                " Id, Name, Familiya FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Familiya] = @Familiya WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Familiya = 1 AND [Familiya] IS NULL) OR ([Familiya] = @Original_Familiya)));
SELECT Id, Name, Familiya FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Familiya FROM dbo.[Table]";
        ...
        public virtual int Insert(string Name, string Familiya) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Familiya, int Original_Id, string Original_Name, string Original_Familiya, int Id) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Familiya, int Original_Id, string Original_Name, string Original_Familiya) {
            return this.Update(Name, Familiya, Original_Id, Original_Name, Original_Familiya, Original_Id);
        }
    }
